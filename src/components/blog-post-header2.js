      ...
      <div className="blog-post-header2-max-width thq-section-max-width">
        <div className="blog-post-header2-section-title thq-flex-column">
          <div className="blog-post-header2-title thq-flex-column">
            <div className="blog-post-header2-content">
            ...
            <div className="blog-post-header2-content1">
              <h1 className="blog-post-header2-text1 thq-heading-1">
                {props.blogPostTitle}
              </h1>
...
BlogPostHeader2.defaultProps = {
  ...
  blogPostImageAlt: 'UI/UX Design Process',
  avatarName: 'John Doe',
  blogPostTitle: 'The Importance of UI/UX Design in Digital Products',
  category: 'UI/UX Design',
  readTime: '5 min read',
  blogPostImageSrc:
    'https://images.unsplash.com/photo-1501556466850-7c9fa1fccb4c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxNjEwNTIxN3w&ixlib=rb-4.0.3&q=80&w=1080',
}
